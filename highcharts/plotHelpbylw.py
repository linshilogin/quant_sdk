...
from .highstock.common import Formatter
from .highstock.common import JSfunction
from .highstock.common import Formatter
from .highstock.common import Tooltip
...
def plotLine(dataDf,symbol_):
    ...
    addASeries(H, dataDf, symbol_,tooltip=atooltipValue)
...
def plotAContractCandle(underlyingAsset,sDateTime,eDateTime,fre='60s'):
    ...
    #画k线
    hqDF=gm3HelpBylw.getHQData_Fade([underlyingAsset], sDateTime, eDateTime,fre)
    aPlotData = hqDF[['eob', 'open', 'high', 'low', 'close']]
    plotCandle(H, aPlotData, underlyingAsset)
